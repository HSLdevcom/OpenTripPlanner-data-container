...
module.exports = {
  ...
  gtfs: [
    ...
    mapSrc(
      'MATKA',
      'https://mobility.mobility-database.fintraffic.fi/static/digitransit_new.zip',
      true,
    ),
    mapSrc(
      'flixbus',
    ...
    mapSrc(
      'Harma',
      'https://harmanliikenne.bussikaista.fi/sites/harma/files/gtfs/export/latest.zip',
      true,
    ),
    mapSrc(
      'PohjolanMatka',
      'https://minfoapi.matkahuolto.fi/gtfs/458/gtfs.zip',
      true,
    ),
    mapSrc(
      'Korsisaari',
